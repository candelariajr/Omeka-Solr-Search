...
Official development has stopped on this plugin. I (@candelariajr) have taken over in order to keep developing it as we love to use the plugin. It was rewritten for 7.4 and soon to be updated to 8.1

This couldn't have been accomplished without help from:

The Scholars Lab Team
